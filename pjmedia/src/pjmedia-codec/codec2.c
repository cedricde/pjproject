...
/*
 * Only build this file if PJMEDIA_HAS_CODEC2 != 0
 */
#if defined(PJMEDIA_HAS_CODEC2) && PJMEDIA_HAS_CODEC2 != 0
...
#define CODEC2_MODE                 PJMEDIA_CODEC2_DEFAULT_MODE
